...
const CASES: Case[] = [
  ...
  { q: "Have you worked in healthcare?", expect: ["Project · Healthcare Platform", "Hyscaler · Experience"] },
  { q: "Do you know HIPAA and FHIR?", expect: ["Project · Healthcare Platform"] },
  ...
  { q: "Any school fundraising projects?", expect: ["Project · School Fundraising Donation Platform"] },
  { q: "Have you built a mobile app?", expect: ["Project · Walking Pal"] },
  { q: "Have you worked at a startup?", expect: ["Project · Walking Pal"] },
  { q: "How does the QR check-in work?", expect: ["Project · Walking Pal"] },
  { q: "Do you have coffee coupons or rewards?", expect: ["Project · Walking Pal"] },
